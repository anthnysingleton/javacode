...
public final class Translate extends MicrosoftTranslatorAPI {
     ...
     * @param french The language code to translate from.
     * @param english The language code to translate to.
     * @return The translated String.
     * @throws Exception on error.
     */
    public static String execute(final String text, final Object french, final Object english) throws Exception {
        //Run the basic service validations first
        validateServiceState(text); 
        final String params = 
                (apiKey != null ? PARAM_APP_ID + URLEncoder.encode(apiKey,ENCODING) : "") 
                + PARAM_FROM_LANG + URLEncoder.encode(french.toString(),ENCODING) 
                + PARAM_TO_LANG + URLEncoder.encode(english.toString(),ENCODING) 
