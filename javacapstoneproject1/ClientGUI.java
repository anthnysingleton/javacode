...
public class ClientGUI extends JFrame implements ActionListener {
 ...
 ClientGUI(String host, int port) {
  ...
  // the Label and the TextField for language
  label = new JLabel("Enter your language below", SwingConstants.LEFT);
  northPanel.add(label);
  
  Vector<String> languageItem=new Vector<String>();
  for(Language lang : Language.values()) {
   languageItem.add(lang.name());
   }
  
  
   cbLanguage = new JComboBox(languageItem);
   cbLanguage.setBackground(Color.WHITE);
   northPanel.add(cbLanguage);
  ...
  // the Label and the TextField for username
  label = new JLabel("Enter your username below", SwingConstants.LEFT);
  northPanel.add(label);
  tfUserName = new JTextField("Anonymous");
 ...
 void connectionFailed() {
  ...
  tfUserName.removeActionListener(this);
  connected = false;
 }
 ...
 public void actionPerformed(ActionEvent e) {
  ...
  if (connected) {
   ...
   client.sendMessage(new ChatMessage(ChatMessage.MESSAGE, tfUserName
     .getText()));
   tfUserName.setText("");
   return;
  }
  ...
  if (o == cbLanguage){
   ...
   //String languageName = (String)cb.getSelectedItem();
  ...
  if (o == login) {
   ...
   client = new Client(server, port, username, (String) cbLanguage.getSelectedItem(),
     this);
