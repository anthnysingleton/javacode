...
public class Client {
  ...
  */
 Client(String server, int port, String username, String language) {
  // which calls the common constructor with the GUI set to null
  this(server, port, username, language, null);
 }
 ...
 Client(String server, int port, String username, String language,
  ...
  this.cg = cg;
   ...
   for(Language lang : Language.values()) {
    ...
    if(this.language.equalsIgnoreCase(lang.name()))
    {
     myLanguage=lang;
     break;
    }
 ...
 private void display(String msg) {
  if (cg == null)
   ...
   String translatedText = translateMessage(msg);
   cg.append(translatedText + "\n"); // append to the ClientGUI JTextArea (or
         // whatever)
  }
 }

 private String translateMessage(String msg) {
  Translate.setClientId("BabelChat485");
  Translate
    .setClientSecret("wFa96FKfCzOkXaR3aEKwaOGiUR630diqoNvYWLS1WPs=");
  String translatedText = msg;
  try {
   translatedText = Translate.execute(msg, Language.ENGLISH, myLanguage);
  } catch (Exception e) {
 ...
 public static void main(String[] args) {
  ...
  String language = "Enter Language";

  // depending of the number of arguments provided we fall through
  switch (args.length) {
  // > javac Client username language portNumber serverAddr
  case 3:
   serverAddress = args[2];
   // > javac Client username language portNumber
  case 2:
   try {
    ...
    System.out
      .println("Usage is: > java Client [username] [portNumber] [serverAddress] [language]");
    return;
   }
