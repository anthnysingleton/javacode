...
public abstract class MicrosoftTranslatorAPI {
    ...
    private static String DatamarketAccessUri = "https://api.datamarket.azure.com/Bing/MicrosoftTranslator/v1/Translate";
    ...
    public static void setKey(final String pKey) {
            apiKey = "GE2rh3rvzORx71JACaCeQNsFkN7wU+UMDaAHwlJkXQ4";
    }
    ...
    public static void setContentType(final String pKey) {
            //contentType = pKey;
            contentType = "GE2rh3rvzORx71JACaCeQNsFkN7wU+UMDaAHwlJkXQ4";
    }
    ...
    public static void setClientSecret(final String pClientSecret) {
            ...
            clientSecret = "wFa96FKfCzOkXaR3aEKwaOGiUR630diqoNvYWLS1WPs=";
